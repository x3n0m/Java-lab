//Database application using MySQL 
package labsheet3;
...
stmt.executeUpdate(query); // This method is used for execution of DML statement (INSERT, UPDATE and DELETE) which is return int value, count of the affected rows. 
...
query = "update emp set ename=? where eno=? "; 
...
//The getInt () method of Field class gets the value of a static or instance field of type int    
